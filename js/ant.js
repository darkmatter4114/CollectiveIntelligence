...
var Canvas = (function () {
    ...
    Canvas.prototype.getMouseX = function(e) { return this._mousePos.x };
    ...
    Canvas.prototype._updateMouseXY = function(mouseEvt) {
        ...
        this._mousePos.x = x;
        this._mousePos.y = y;
        // var qwer=document.getElementById('city_x').oninput= this._mousePos.x;
        // document.getElementById('city_x').oninput= this._mousePos.x;

        // document.getElementById('city_x').innerHTML=qwer;
    };
...
var City = (function () {
    function City(x, y) {
        this._x = x;
        this._y = y;
        // document.getElementById('city_x').innerHTML=this._x;
    }
